...
final class StartingListPrintController extends AbstractController
{
    public const string ROUTE_NAME = 'admin_dashboard_' . self::PART_ROUTE_NAME;
    private const string PART_ROUTE_NAME = 'competition_staring_list_print';
    ...
    #[AdminRoute(
        path: '/{entityId}/staring-list/print',
